...
par(mfrow = c(2, 2))
plot(timestamp, datas$Global_active_power, type="l", xlab="", ylab="Global Active Power")

plot(timestamp, datas$Voltage, type="l", xlab="datetime", ylab="Voltage")
...
legend("topright", lty = 1, lwd=2, seg.len=1, bty="n", col = c("black", "red", "blue"), legend = c("Sub_metering_1    ", "Sub_metering_2    ", "Sub_metering_3    "))

plot(timestamp, datas$Global_reactive_power, type="l", xlab="datetime", ylab="Global_reactive_power")

dev.copy(png, file = "plot4.png", width = 480, height = 480, units = "px", bg = "white")  ## Copy my plot to a PNG file
